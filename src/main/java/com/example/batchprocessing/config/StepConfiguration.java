...
public class StepConfiguration {
    /* We have 3 main part in chunk-based step: ItemReader, ItemProcessor, ItemWriter */
    ...
    public Step upperCaseStep(JobRepository jobRepository,
        ...
        return new StepBuilder("upperCaseStep", jobRepository)
                ...
                .reader(personItemReader()) // method invoke
                .processor(personItemProcessor()) // method invoke
                .writer(itemWriter) // from parameter
                .build();
    }
}
